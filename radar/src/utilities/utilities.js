...
/** Map-local pixel position from normalized 0–1 coords (unaffected by zoom/pan). */
export const getEntityTranslate = (mapW, mapH, normPos, entityW = 0, entityH = 0) => ({
  x: mapW * normPos.x - entityW * 0.5,
  y: mapH * normPos.y - entityH * 0.5,
});
